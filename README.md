...
```text
classes.xsl              30474  30.60%
to-java.xsl              30229  30.36%
set-locators.xsl         9367   9.41%
set-original-names.xsl   7035   7.06%
attrs.xsl                5076   5.10%
data.xsl                 4531   4.55%
tests.xsl                4337   4.36%
anonymous-to-nested.xsl  4333   4.35%
package.xsl              4196   4.21%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-30 at 18:12,
on Linux with 4 CPUs.
The total is 99578 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/30568298846
